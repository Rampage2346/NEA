...
__all__ = [
    'SAFT22kHz16BitMono', 'SPBOOKMARKOPTIONS', 'SRCS_Disabled',
    'DISPID_SPEAudioStreamOffset', 'SPSUnknown', 'ISpResourceManager',
    'Speech_StreamPos_RealTime', 'DISPID_SPIAudioStreamPosition',
    'SPSInterjection', 'SPSEMANTICERRORINFO', 'DISPID_SASetState',
    'DISPID_SPAPhraseInfo', 'ISpRecoCategory', 'DISPID_SPIElements',
    'SAFT24kHz16BitMono', 'DISPID_SGRInitialState', 'SPSHT_EMAIL',
    'SPSSuppressWord', 'DISPID_SOTRemoveStorageFileName',
    'SVSFVoiceMask', 'SPVOICESTATUS', 'SWPUnknownWordPronounceable',
    'DISPID_SPRsCount', 'SAFT8kHz8BitStereo', 'SRTReSent',
    'ISpObjectToken', 'DISPID_SRCCreateResultFromMemory',
    'ISpeechVoice', 'ISpPhrase', 'DISPID_SpeechRecoResult',
    'SPEI_END_SR_STREAM', 'SPEI_RESERVED3',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPIDSPTSI',
    'DISPID_SPRulesCount', 'SP_VISEME_0', 'DISPID_SRRGetXMLErrorInfo',
    'SRSEIsSpeaking', 'SVP_17', 'ISpRecognizer3',
    'SSSPTRelativeToEnd', 'ISpeechDataKey',
    'DISPID_SRGSetTextSelection', 'ISpRecoGrammar2', 'SVP_2',
    'SPEI_SOUND_END', 'ISpeechPhraseProperties', 'eWORDTYPE_DELETED',
    'DISPID_SpeechPhraseReplacements', 'SSTTDictation',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SASClosed', 'DISPID_SVSpeak',
    'ISpGrammarBuilder', 'SPSHT_OTHER', 'SpeechAudioFormatGUIDText',
    'SDTLexicalForm', 'DISPID_SPEAudioSizeBytes', 'DISPID_SPPId',
    'SPPS_SuppressWord', 'SAFT22kHz8BitMono',
    'DISPID_SOTIsUISupported', 'SPWORDLIST', 'SAFTGSM610_11kHzMono',
    'SPFM_OPEN_READONLY', 'SPCT_COMMAND', 'ISpeechMMSysAudio',
    'Speech_Max_Word_Length', 'SREPropertyStringChange',
    'SPEI_PHONEME', 'DISPID_SOTsItem', 'SpNotifyTranslator',
    'ISpeechRecoResult2', 'DISPID_SPIGetText', 'DISPID_SVStatus',
    'DISPID_SDKEnumValues', 'SAFT44kHz8BitMono', 'DISPID_SPRsItem',
    'DISPID_SPPsCount', 'SPLO_DYNAMIC', 'SPEI_RESERVED2',
    'SP_VISEME_16', 'SpeechLexiconType', 'DISPID_SGRsAdd',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SVSkip', 'SGDSActive',
    'SVESentenceBoundary', 'SPEI_MIN_SR', 'SLODynamic',
    'DISPID_SRSetPropertyNumber', 'SVF_None',
    'DISPID_SABufferNotifySize', 'SPINTERFERENCE',
    'SpeechStreamFileMode', 'DISPID_SVResume', 'eLEXTYPE_PRIVATE1',
    'DISPID_SGRSTPropertyName', 'IEnumSpObjectTokens',
    'DISPID_SVEVoiceChange', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SRGetFormat', 'DISPID_SVDisplayUI',
    'DISPID_SRSCurrentStreamPosition', 'SSFMOpenForRead',
    'SVSFIsNotXML', 'DISPID_SDKGetStringValue',
    'DISPID_SOTCEnumerateTokens', 'SPPS_Verb',
    'DISPID_SRGetPropertyString', 'DISPID_SPEsItem', 'DISPID_SOTCId',
    '__MIDL_IWinTypes_0009', 'DISPID_SpeechAudio',
    'SAFTADPCM_11kHzMono', 'DISPID_SGRSTType', 'SPEVENTSOURCEINFO',
    'SPRST_INACTIVE', 'ISpShortcut', 'ISpeechAudioStatus',
    'DISPID_SRRAudio', 'STCInprocServer', 'DISPID_SRRTimes',
    'ISpeechGrammarRuleStateTransition', 'SVEPhoneme',
    'DISPID_SpeechPhraseElement', 'ISpRecognizer2', 'ISpEventSink',
    'SDTReplacement', 'DISPID_SRRecognizer',
    'DISPID_SRGSetWordSequenceData', 'SBOPause',
    'SPEI_FALSE_RECOGNITION', 'SpTextSelectionInformation',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SPRNumberOfElements',
    'DISPID_SGRsCount', 'ISpMMSysAudio', 'SRERecoOtherContext',
    'SPBO_PAUSE', 'DISPID_SRCEventInterests', 'SREStreamEnd',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SGRSRule',
    'DISPID_SVESentenceBoundary', 'DISPID_SRCEEnginePrivate',
    'SAFT12kHz8BitStereo', 'DISPID_SRCESoundStart',
    'SAFTADPCM_44kHzStereo', 'SpeechTokenKeyUI',
    'SpeechAddRemoveWord', 'SVP_11', 'SRTStandard',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SpInProcRecoContext',
    'DISPID_SPRText', 'SINoSignal', 'DISPID_SASNonBlockingIO',
    'SPEI_RESERVED1', 'DISPID_SPPFirstElement', 'SpSharedRecoContext',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SpeechLexiconProns',
    'DISPID_SPRuleId', 'SPEI_START_INPUT_STREAM',
    'SpeechVoiceSkipTypeSentence', 'SREFalseRecognition',
    'SAFT44kHz8BitStereo', 'SITooFast', 'STCRemoteServer',
    'DISPID_SMSADeviceId', 'SPCT_SUB_COMMAND', 'SAFT24kHz8BitStereo',
    'SGSExclusive', 'SPFM_NUM_MODES', 'SP_VISEME_12',
    'SPRST_NUM_STATES', 'SpPhoneticAlphabetConverter',
    'DISPID_SRCEFalseRecognition', 'eLEXTYPE_RESERVED8',
    'SpeechEngineConfidence', 'DISPID_SPRs_NewEnum', 'SVEViseme',
    'DISPID_SAFGetWaveFormatEx', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SRRPhraseInfo', 'eLEXTYPE_PRIVATE16', 'DISPID_SPPValue',
    'DISPID_SVSPhonemeId', 'DISPID_SVGetAudioInputs',
    'SPEI_INTERFERENCE', 'DISPID_SPPName', 'SpStream',
    'DISPID_SVAudioOutput', 'DISPID_SRRRecoContext', 'SPPS_RESERVED4',
    'SVP_8', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SLAddPronunciation', 'SWPKnownWordPronounceable',
    'DISPID_SLWsItem', 'SPEI_HYPOTHESIS', 'SPINTERFERENCE_TOOQUIET',
    'ISpEventSource', 'SPEI_SR_AUDIO_LEVEL', 'SpeechAudioState',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SPDKL_CurrentUser',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SAFType',
    'DISPID_SVWaitUntilDone', 'eLEXTYPE_RESERVED7',
    'SpeechGrammarWordType', 'DISPID_SLWsCount',
    'DISPID_SRGCmdLoadFromFile', 'SGSDisabled',
    'SPXRO_Alternates_SML', 'DISPID_SPIAudioSizeTime',
    'DISPID_SRCESoundEnd', 'DISPID_SRGCmdLoadFromResource', 'SVP_5',
    'eLEXTYPE_RESERVED9', 'DISPID_SVSVisemeId', 'eLEXTYPE_RESERVED10',
    'SREPrivate', 'DISPID_SRIsUISupported', 'SAFTADPCM_44kHzMono',
    'SAFT12kHz8BitMono', 'DISPID_SVVolume', 'DISPID_SOTDataKey',
    'DISPID_SRGCommit', 'SPPHRASERULE', 'SREBookmark',
    'ISpeechRecoContext', 'SpeechGrammarTagDictation',
    'DISPID_SPEAudioSizeTime', 'SPEI_MIN_TTS', 'SITooQuiet',
    'SAFT32kHz8BitStereo', 'DISPID_SRCEAdaptation', 'SVPAlert',
    'SREInterference', 'SpeechDisplayAttributes',
    'SAFTNonStandardFormat', 'SpeechFormatType',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SLGenerationId',
    'SpInprocRecognizer', 'DISPID_SPAsCount', 'eLEXTYPE_PRIVATE9',
    'SPEI_END_INPUT_STREAM', 'SpeechUserTraining', 'DISPID_SAFGuid',
    'ISpStreamFormat', 'DISPID_SOTDisplayUI', 'DISPID_SPARecoResult',
    'SVSFlagsAsync', 'DISPID_SDKGetlongValue', 'SREPropertyNumChange',
    'SAFTCCITT_uLaw_11kHzMono', 'ISpeechLexiconPronunciations',
    'SRARoot', 'DISPID_SVVoice', 'SpeechRecoProfileProperties',
    'DISPID_SpeechDataKey', 'DISPID_SpeechMMSysAudio',
    '_SPAUDIOSTATE', 'SPAS_RUN', 'SVP_12', 'SPRST_ACTIVE',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SABufferInfo',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SVSLastResult',
    'DISPID_SPACommit', 'SVP_4', 'SVP_13',
    'SpeechAudioFormatGUIDWave', 'SAFTCCITT_uLaw_44kHzMono',
    'SPPS_Noncontent', 'DISPID_SVGetAudioOutputs', 'SVSFNLPSpeakPunc',
    'DISPID_SLPsCount', 'SpMMAudioIn', 'DISPID_SPEAudioTimeOffset',
    'SRERequestUI', 'DISPID_SRGRules', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SRCEStartStream', 'DISPID_SGRSAddWordTransition',
    'SRTExtendableParse', 'SpStreamFormatConverter',
    'SAFTCCITT_uLaw_8kHzMono', 'SpeechBookmarkOptions',
    'SGDSActiveWithAutoPause', 'SpeechGrammarTagWildcard',
    'eLEXTYPE_PRIVATE14', 'SpeechRecoEvents', 'SVSFUnusedFlags',
    'SPDKL_DefaultLocation', 'DISPID_SABIMinNotification',
    'DISPID_SDKDeleteKey', 'DISPID_SRSNumberOfActiveRules',
    'SAFT16kHz16BitStereo', 'DISPID_SWFESamplesPerSec',
    'SPEI_RESERVED6', 'SpeechVoiceEvents', 'SPPS_Interjection',
    'SPRST_ACTIVE_ALWAYS', 'eLEXTYPE_PRIVATE10', 'SPPS_RESERVED1',
    'DISPID_SpeechRecognizer', 'DISPID_SOTs_NewEnum',
    'DISPID_SDKCreateKey', 'DISPID_SDKSetStringValue',
    'DISPID_SDKEnumKeys', 'ISpeechVoiceStatus',
    'DISPID_SPERequiredConfidence', 'DISPID_SRGIsPronounceable',
    'SPGS_DISABLED', 'DISPIDSPTSI_ActiveOffset', 'SPRS_INACTIVE',
    'DISPID_SASState', 'DISPID_SRGCmdLoadFromObject',
    'SPSERIALIZEDRESULT', 'DISPID_SVSInputSentencePosition',
    'SVEStartInputStream', 'SASPause', 'DISPID_SVSLastBookmark',
    'ISpeechTextSelectionInformation', 'DISPID_SRAudioInput',
    'SPAS_PAUSE', 'DISPID_SPERetainedStreamOffset', 'SpObjectToken',
    'DISPID_SPIEnginePrivateData', 'ISpRecoContext', 'SVF_Stressed',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SPRuleName',
    'SpeechCategoryVoices', 'SP_VISEME_9', 'SPSHORTCUTPAIR',
    'SPFM_CREATE', 'STCAll', 'DISPID_SRGRecoContext', 'WAVEFORMATEX',
    'DISPID_SVSLastBookmarkId', 'LONG_PTR', 'SVP_19',
    'SPEI_RESERVED5', 'SpeechTokenKeyFiles',
    'DISPID_SPIAudioSizeBytes',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SBSWrite', 'SLOStatic',
    'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SRCEHypothesis', 'SAFT8kHz16BitStereo',
    'STSF_CommonAppData', 'UINT_PTR', 'ISpLexicon',
    'DISPID_SPEDisplayText', 'SAFT12kHz16BitMono',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SAFTCCITT_ALaw_22kHzMono', 'SSTTWildcard', 'DISPID_SPCLangId',
    'DISPID_SPPEngineConfidence', 'ISpeechPhraseRule',
    'SGPronounciation', 'SPSMF_UPS', 'SAFTExtendedAudioFormat',
    'SP_VISEME_4', 'DISPID_SRGDictationSetState',
    'eLEXTYPE_VENDORLEXICON', 'SPPARTOFSPEECH', 'SSFMCreateForWrite',
    'DISPID_SRCEEndStream', 'DISPID_SRGCmdSetRuleIdState',
    'DISPID_SVSpeakStream', 'SVPOver', 'ISpeechMemoryStream',
    'DISPID_SGRSTransitions', 'DISPID_SVSInputSentenceLength',
    'SpeechCategoryAudioIn', 'DISPID_SABIEventBias',
    'SPSEMANTICFORMAT', 'DISPID_SRRSpeakAudio', 'SGRSTTDictation',
    'SDKLCurrentConfig', 'SpFileStream', 'SGLexicalNoSpecialChars',
    'SECFIgnoreKanaType', 'DISPID_SPPsItem',
    'SAFTTrueSpeech_8kHz1BitMono', 'SpeechRegistryUserRoot',
    'SpeechAllElements', 'SAFTCCITT_ALaw_8kHzStereo', 'SGRSTTWord',
    'SP_VISEME_11', 'SAFT32kHz16BitStereo', 'STCInprocHandler',
    'SPXMLRESULTOPTIONS', 'DISPID_SRGDictationLoad',
    'DISPID_SVEEnginePrivate', 'DISPID_SRCAudioInInterferenceStatus',
    'eWORDTYPE_ADDED', 'SPSFunction', 'DISPID_SRCEInterference',
    'SRSActiveAlways', 'tagSPPROPERTYINFO', 'SDTPronunciation',
    'SPPHRASE', 'SpMMAudioOut', 'SPPS_RESERVED2',
    'SpObjectTokenCategory', 'eLEXTYPE_APP', 'SpNullPhoneConverter',
    'DISPID_SRCEBookmark', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SGRSTRule', 'DISPID_SPIStartTime', 'SPPS_Unknown',
    'SRAExport', 'STSF_AppData', 'SpAudioFormat', 'SP_VISEME_14',
    'DISPID_SVAudioOutputStream', 'DISPID_SRCSetAdaptationData',
    'SPPHRASEREPLACEMENT', 'SPEVENT', 'SRSInactive',
    'SpeechDictationTopicSpelling', 'DISPID_SVGetVoices',
    'DISPID_SLWLangId', 'SPEI_PHRASE_START', 'SINone',
    'DISPID_SPIEngineId', 'SPWORD', 'SAFTDefault',
    'ISpStreamFormatConverter', 'SPEI_MAX_SR', 'SP_VISEME_3',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SP_VISEME_2',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPIDSPRG', 'SPLOADOPTIONS',
    'SECLowConfidence', 'DISPID_SGRsFindRule',
    'SpeechCategoryPhoneConverters', 'DISPID_SVGetProfiles',
    'DISPID_SpeechRecoResult2', 'DISPID_SAStatus', 'SRAONone',
    'SDKLDefaultLocation', 'SREAdaptation', 'SPTEXTSELECTIONINFO',
    'SAFTCCITT_uLaw_22kHzMono', 'SGDisplay', 'SFTSREngine',
    'DISPID_SPEEngineConfidence', 'DISPID_SRCEPropertyStringChange',
    'eLEXTYPE_PRIVATE15', 'DISPID_SRCPause', 'DISPID_SOTRemove',
    'DISPID_SpeechAudioFormat', 'SPWORDTYPE', 'DISPID_SGRAddResource',
    'DISPID_SpeechVoice', 'SpeechMicTraining',
    'DISPID_SVEStreamStart', 'SpVoice', 'SPPHRASEPROPERTY',
    'ISpeechGrammarRule', 'DISPID_SRCRetainedAudioFormat',
    'SPDATAKEYLOCATION', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SGRSTWeight', 'SPVPRI_OVER', 'SPBO_AHEAD',
    'SpeechPropertyResponseSpeed', 'DISPID_SPRuleFirstElement',
    'ISpeechPhraseReplacement', 'ISpeechFileStream',
    'IInternetSecurityMgrSite', 'SPPS_RESERVED3', 'IEnumString',
    'DISPID_SpeechRecognizerStatus', 'SPRECOGNIZERSTATUS',
    'SECHighConfidence', 'STCLocalServer', 'DISPID_SPIRule',
    'eLEXTYPE_PRIVATE3', 'SVP_20', 'SVP_18', 'SpMMAudioEnum',
    'SAFT11kHz8BitStereo', 'DISPID_SPCPhoneToId', 'SPEI_VISEME',
    'DISPID_SPRuleParent', 'ISpPhoneticAlphabetConverter',
    'SPAUDIOSTATE', 'SINoise', 'DISPID_SRState',
    'SSSPTRelativeToCurrentPosition', 'SAFTGSM610_44kHzMono',
    'SPFM_CREATE_ALWAYS', 'ISpObjectWithToken', 'ISpNotifySource',
    'eLEXTYPE_PRIVATE2', 'SpLexicon', 'SAFT11kHz16BitMono',
    'SP_VISEME_7', 'DISPID_SpeechAudioStatus', 'SPSModifier',
    'DISPID_SRRGetXMLResult', 'SpUnCompressedLexicon',
    'SAFTADPCM_22kHzMono', 'SVEAudioLevel', 'SPAO_NONE',
    'SPPS_NotOverriden', 'SAFT48kHz8BitStereo', 'SPPHRASEELEMENT',
    'SGLexical', 'SAFT11kHz8BitMono', 'SPVPRIORITY',
    'DISPID_SLPsItem', 'DISPID_SOTCGetDataKey', 'SDTRule', 'SAFTText',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SRTEmulated',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SPRFirstElement',
    'DISPID_SGRSTPropertyValue', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SPRules_NewEnum', 'SRESoundEnd', 'SpeechGrammarState',
    'SPBINARYGRAMMAR', 'SPWORDPRONUNCIATIONLIST', 'eLEXTYPE_USER',
    'ISpeechAudio', 'SAFT16kHz8BitStereo', 'SPEI_RECOGNITION',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SECNormalConfidence', 'DISPID_SPIProperties', 'SRAInterpreter',
    'ISpNotifyTranslator', 'SPPS_Function', 'SpeechAudioVolume',
    'DISPID_SDKSetLongValue', 'DISPID_SPEs_NewEnum',
    'DISPID_SLRemovePronunciation', 'SPSTREAMFORMATTYPE',
    'SPEI_SR_PRIVATE', 'SAFTGSM610_22kHzMono', 'DISPID_SRCERequestUI',
    'DISPID_SGRSTsItem', 'SAFT8kHz16BitMono', 'SFTInput',
    'SECFIgnoreCase', 'DISPID_SpeechPhraseBuilder', 'SGRSTTEpsilon',
    'SpeechTokenKeyAttributes', 'SVSFParseSapi',
    'DISPID_SOTCreateInstance', 'SPEI_START_SR_STREAM',
    'SRESoundStart', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SABIBufferSize', 'SVSFPersistXML', 'SVSFNLPMask',
    'SPVPRI_NORMAL', 'SECFEmulateResult', 'SPAO_RETAIN_AUDIO',
    'SpeechVisemeFeature', 'SVP_3', 'DISPID_SRRTLength',
    'DISPID_SRCRetainedAudio', 'SAFT24kHz8BitMono',
    'DISPID_SPPNumberOfElements', 'SVP_7', 'SPGRAMMARSTATE',
    'SAFTADPCM_22kHzStereo', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SpeechPhraseAlternate',
    'SPAUDIOBUFFERINFO', 'SPRULE', 'SAFT12kHz16BitStereo',
    'SP_VISEME_1', 'DISPID_SPANumberOfElementsInResult',
    'ISpeechWaveFormatEx', 'SP_VISEME_19', 'DISPID_SGRsDynamic',
    'ISpeechPhraseReplacements', 'SASRun', 'DISPID_SPPParent',
    'ISpNotifySink', 'SpSharedRecognizer', 'SPCS_DISABLED',
    'SpeechEngineProperties', 'DISPID_SpeechVoiceStatus',
    'DISPID_SGRSTNextState', 'SPSHT_NotOverriden', 'DISPID_SAVolume',
    'SP_VISEME_13', 'DISPID_SpeechPhoneConverter', 'SPRULESTATE',
    'DISPID_SWFEBlockAlign', 'ISpeechPhraseElements',
    'SGRSTTTextBuffer', 'SpeechGrammarRuleStateTransitionType',
    'SpeechRecoContextState', 'Speech_Default_Weight', 'SRSActive',
    'SP_VISEME_5', 'SASStop', 'DISPID_SRGReset',
    'DISPID_SpeechBaseStream', 'ISpeechRecoResultDispatch',
    'DISPID_SRCRecognizer', 'SPBO_TIME_UNITS', 'SPCT_DICTATION',
    'SVEWordBoundary', 'SPAUDIOSTATUS', 'SLTUser',
    'DISPID_SRCRequestedUIType', 'SpeechCategoryAudioOut',
    '_RemotableHandle', '_ISpeechVoiceEvents', 'SPWT_DISPLAY',
    'SPINTERFERENCE_NONE', 'DISPID_SOTCDefault', 'SBONone',
    'DISPID_SLAddPronunciationByPhoneIds',
    'SPEI_PROPERTY_STRING_CHANGE', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SpeechPhraseProperty', 'SVSFPurgeBeforeSpeak',
    'SPRECORESULTTIMES', 'DISPID_SPRulesItem',
    'ISpObjectTokenCategory', 'SpeechDiscardType',
    'SAFT24kHz16BitStereo', 'DISPID_SPILanguageId',
    'SAFT32kHz8BitMono', 'ISpRecoContext2', 'SpeechVoicePriority',
    'SWPUnknownWordUnpronounceable', 'SVSFIsFilename',
    'STSF_FlagCreate', 'DISPID_SGRClear', 'SpeechCategoryAppLexicons',
    'DISPID_SpeechPhraseRules', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SpeechRecoContextEvents', 'SREStreamStart',
    'DISPID_SRGCmdSetRuleState', 'SPEI_VOICE_CHANGE',
    'ISpeechObjectTokens', 'Speech_Max_Pron_Length',
    'SPSERIALIZEDPHRASE', 'SAFTADPCM_8kHzMono', 'SPCONTEXTSTATE',
    'SPCATEGORYTYPE', 'DISPID_SRSClsidEngine', 'SREStateChange',
    'SpeechCategoryRecognizers', 'DISPID_SGRSTs_NewEnum',
    'SPRS_ACTIVE', 'DISPID_SRCEAudioLevel', 'DISPID_SPRuleConfidence',
    'SPFILEMODE', 'SP_VISEME_21', 'SVP_9', 'DISPID_SWFEChannels',
    'ISpAudio', 'SPRECOSTATE', 'SpeechAudioProperties',
    'SAFT11kHz16BitStereo', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SpeechPhraseElements',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SGRSTsCount',
    'SPWF_INPUT', 'SPFM_OPEN_READWRITE', 'DISPID_SpeechRecoContext',
    'DISPID_SASFreeBufferSpace', 'DISPID_SOTSetId', 'DISPID_SGRName',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SpeechGrammarRule',
    'SAFT48kHz16BitStereo', 'SAFTADPCM_8kHzStereo', 'SPAS_CLOSED',
    'DISPID_SRRSaveToMemory', 'SPEI_SR_BOOKMARK',
    'DISPID_SpeechPhraseInfo', 'SPGS_ENABLED',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SPEPronunciation',
    'DISPID_SpeechMemoryStream', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SRGDictationUnload', 'DISPID_SRCResume',
    'DISPID_SpeechXMLRecoResult',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SLPs_NewEnum',
    'SPEI_MAX_TTS', 'SVP_6', 'eLEXTYPE_PRIVATE6', 'IStream',
    'ISpPhraseAlt', 'DISPID_SRGState', 'ISpVoice',
    'ISequentialStream', 'DISPID_SRRTTickCount',
    'DISPID_SVSpeakCompleteEvent', 'SpeechAudioFormatType',
    'SpeechPropertyResourceUsage', 'DISPID_SVEPhoneme',
    'DISPID_SPELexicalForm', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SWFEFormatTag', 'DISPID_SBSFormat', 'SPWORDPRONUNCIATION',
    'SpeechTokenIdUserLexicon', 'SPAR_Low',
    'SAFTCCITT_ALaw_22kHzStereo', 'SWTAdded', 'SPSHORTCUTTYPE',
    'SPDKL_LocalMachine', 'SpeechInterference', 'SPSHT_Unknown',
    'ISpeechPhraseInfo', 'SPSNoun',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SPEI_ADAPTATION',
    'DISPID_SOTCategory', 'DISPID_SGRs_NewEnum',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SGRSTPropertyId',
    'SRCS_Enabled', 'DISPID_SVSCurrentStreamNumber',
    'DISPID_SVAlertBoundary', 'SREAllEvents', 'SAFT32kHz16BitMono',
    'SPVPRI_ALERT', 'ISpStream', 'DISPID_SLPLangId',
    'SPEI_TTS_PRIVATE', 'DISPID_SAEventHandle', 'SP_VISEME_17',
    'SREHypothesis', 'DISPID_SLGetPronunciations',
    'DISPID_SRRTOffsetFromStart', 'SDA_No_Trailing_Space',
    'eLEXTYPE_PRIVATE20', 'SpeechTokenShellFolder',
    'DISPID_SGRsCommit', 'ISpeechAudioFormat',
    'DISPID_SRCERecognition', 'SAFTCCITT_uLaw_22kHzStereo',
    'SPWT_LEXICAL', 'SPVISEMES', 'SPRECOCONTEXTSTATUS',
    'SDKLLocalMachine', 'SPINTERFERENCE_NOSIGNAL',
    'eLEXTYPE_PRIVATE7', 'DISPID_SRGetPropertyNumber',
    'eLEXTYPE_PRIVATE12', 'DISPID_SLWWord',
    'SpeechRegistryLocalMachineRoot', 'SDTDisplayText',
    'ISpeechPhraseElement', 'DISPID_SGRsCommitAndSave',
    'DISPID_SGRsItem', 'DISPID_SpeechFileStream',
    'DISPID_SLPPartOfSpeech', 'eLEXTYPE_PRIVATE17',
    'eLEXTYPE_PRIVATE5', 'eLEXTYPE_PRIVATE18', 'DISPID_SGRAttributes',
    'SITooSlow', 'SpCompressedLexicon',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SVEBookmark',
    'SECFIgnoreWidth', 'SSTTTextBuffer',
    'SpeechPropertyComplexResponseSpeed', 'SPAR_Unknown',
    'DISPID_SRCVoice', 'SPEI_SENTENCE_BOUNDARY', 'SGRSTTWildcard',
    'SpeechStreamSeekPositionType', 'DISPID_SVPriority',
    'DISPID_SLWs_NewEnum', 'SPAR_High', 'ISpeechRecoResultTimes',
    'DISPID_SRSetPropertyString', 'SVEBookmark', 'SPSLMA',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SRIsShared', 'DISPID_SPAsItem',
    'DISPID_SDKOpenKey', 'SpeechVisemeType', 'SVSFParseSsml',
    'SPAR_Medium', 'SpeechRuleAttributes', 'ISpeechGrammarRules',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SPRDisplayAttributes',
    'DISPID_SRCEPropertyNumberChange', 'ISpeechObjectToken',
    'DISPID_SWFEExtraData', 'SPWF_SRENGINE', 'SP_VISEME_6',
    'DISPID_SFSClose', 'SPPS_LMA',
    'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SpeechWaveFormatEx', 'SWTDeleted',
    'ISpeechPhraseProperty', 'DISPID_SOTGetStorageFileName',
    'DISPID_SPIReplacements', 'SPAS_STOP', 'DISPID_SPPs_NewEnum',
    'SPGRAMMARWORDTYPE', 'SGRSTTRule', 'DISPID_SPAs_NewEnum',
    'eLEXTYPE_PRIVATE13', 'SRSInactiveWithPurge',
    'SDA_One_Trailing_Space', 'DISPIDSPTSI_SelectionOffset',
    'SpeechSpecialTransitionType', 'ISpPhoneConverter',
    'eLEXTYPE_PRIVATE8', 'SVSFDefault', 'DISPID_SVEventInterests',
    'DISPID_SRRSetTextFeedback', 'SPEI_RECO_OTHER_CONTEXT',
    'SP_VISEME_15', 'Speech_StreamPos_Asap', 'DISPID_SRRAudioFormat',
    'DISPID_SRCreateRecoContext', 'DISPID_SMSAMMHandle',
    'SAFT16kHz16BitMono', 'SPSNotOverriden', 'SPADAPTATIONRELEVANCE',
    'SPRST_INACTIVE_WITH_PURGE', 'eLEXTYPE_RESERVED4',
    'SPRS_ACTIVE_USER_DELIMITED',
    'SpeechPropertyHighConfidenceThreshold', 'SVP_15',
    'SPEI_REQUEST_UI', 'DISPID_SLWType', 'DISPID_SGRAddState',
    'SpeechPropertyLowConfidenceThreshold', 'SPEI_TTS_BOOKMARK',
    'SpWaveFormatEx', 'ISpeechXMLRecoResult', 'SpeechRuleState',
    'tagSTATSTG', 'SP_VISEME_18', 'SAFT16kHz8BitMono',
    'SPCT_SUB_DICTATION', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SRSCurrentStreamNumber',
    'SPWAVEFORMATTYPE', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SLPSymbolic', 'SRATopLevel',
    'DISPID_SpeechGrammarRuleState', 'SECFDefault',
    'DISPID_SGRSTText', 'ISpeechLexiconPronunciation',
    'ISpPhoneticAlphabetSelection', 'SpeechTokenContext',
    'DISPID_SPAStartElementInResult', 'SpCustomStream',
    'DISPID_SVSInputWordPosition', 'DISPID_SRRTStreamTime',
    'DISPID_SADefaultFormat', 'DISPID_SLPPhoneIds',
    'DISPID_SVSyncronousSpeakTimeout', 'SAFT48kHz16BitMono',
    'SpPhraseInfoBuilder', 'DISPID_SpeechPhraseProperties',
    'DISPID_SPRuleChildren', 'SP_VISEME_10',
    'DISPID_SpeechCustomStream', 'SpResourceManager',
    'SRADefaultToActive', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SpeechLexiconWords', 'DISPID_SpeechLexicon',
    'DISPID_SBSSeek', 'SPPS_Modifier', 'DISPID_SCSBaseStream',
    'DISPID_SMSSetData', 'SRAORetainAudio', 'SVEVoiceChange',
    'SREPhraseStart', 'DISPID_SDKDeleteValue',
    'DISPID_SVSInputWordLength', 'DISPID_SPPConfidence',
    'DISPID_SpeechGrammarRules', 'SRTSMLTimeout',
    'eLEXTYPE_RESERVED6', 'DISPID_SpeechObjectToken', 'SRADynamic',
    'SAFTGSM610_8kHzMono', 'DISPID_SpeechObjectTokens',
    'SpeechWordPronounceable', 'SECFNoSpecialChars', 'SPEVENTENUM',
    'ISpeechLexiconWord', 'eLEXTYPE_PRIVATE11', 'DISPID_SVEViseme',
    'DISPID_SPCIdToPhone', 'DISPID_SPEActualConfidence',
    'ISpeechObjectTokenCategory', 'SDTAll',
    'IInternetSecurityManager', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SOTGetDescription', 'ISpRecoGrammar',
    'SGDSActiveUserDelimited', 'DISPID_SDKGetBinaryValue',
    'SpeechEmulationCompareFlags', 'SAFTNoAssignedFormat',
    'DISPID_SRSAudioStatus', 'ISpeechAudioBufferInfo', 'SVP_21',
    'DISPID_SpeechGrammarRuleStateTransition', 'SPLEXICONTYPE',
    'SAFT48kHz8BitMono', 'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SRCVoicePurgeEvent', 'SDA_Consume_Leading_Spaces',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SOTMatchesAttributes',
    'SDKLCurrentUser', 'DISPID_SPIRetainedSizeBytes',
    'ISpeechLexiconWords', 'DISPID_SOTId', 'DISPID_SBSRead',
    'DISPID_SWFEBitsPerSample', 'SDA_Two_Trailing_Spaces',
    'DISPID_SOTCSetId', 'SPEI_WORD_BOUNDARY',
    'DISPID_SRCCreateGrammar', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SPSHORTCUTPAIRLIST', 'SpeechPropertyAdaptationOn',
    'SpeechRecognizerState', 'DISPID_SPPChildren', 'SDTProperty',
    'DISPID_SLWPronunciations', 'ISpSerializeState', 'DISPID_SVPause',
    'SSSPTRelativeToStart', 'SAFTADPCM_11kHzStereo',
    'DISPID_SMSGetData', 'SpeechRunState', 'ISpeechRecognizer',
    'DISPID_SpeechAudioBufferInfo', 'SAFT22kHz16BitStereo',
    'DISPID_SVEAudioLevel', 'SVSFParseAutodetect',
    'SpeechVoiceSpeakFlags', 'SpeechRecognitionType', 'DISPID_SRGId',
    'SRERecognition', 'SLTApp', 'DISPID_SpeechLexiconWord',
    'SAFT8kHz8BitMono', 'SpeechCategoryRecoProfiles',
    'DISPID_SRAudioInputStream', 'DISPID_SLGetGenerationChange',
    'SpeechDataKeyLocation', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SLPType', 'DISPID_SRProfile', 'SRAImport',
    'SPGS_EXCLUSIVE', 'SpeechWordType', 'SPPROPERTYINFO',
    'SAFT44kHz16BitMono', 'ISpDataKey', 'SDTAlternates',
    'ISpProperties', 'eLEXTYPE_MORPHOLOGY', 'ISpeechPhoneConverter',
    'SPEI_SOUND_START', 'SITooLoud', 'SP_VISEME_20', 'DISPID_SGRId',
    'SVPNormal', 'SSFMOpenReadWrite', 'DISPID_SPEDisplayAttributes',
    'eLEXTYPE_PRIVATE19', 'SVP_16', 'SAFT44kHz16BitStereo',
    'DISPID_SVSRunningState', 'DISPID_SRCState', 'SP_VISEME_8',
    'SVF_Emphasis', 'ISpeechBaseStream', 'SpPhoneConverter',
    'DISPID_SRCBookmark', 'SVP_0', 'DISPID_SPEsCount', 'SDTAudio',
    'ISpeechPhraseInfoBuilder', 'DISPID_SMSALineId', 'DISPID_SVRate',
    'ISpeechCustomStream', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SpeechPhraseRule', 'DISPID_SOTGetAttribute',
    'SRTAutopause', 'SpeechLoadOption', 'SPXRO_SML', 'ISpRecoResult',
    'ISpRecognizer', 'SpeechPartOfSpeech', 'DISPID_SDKSetBinaryValue',
    'ISpeechRecoResult', 'SPWT_PRONUNCIATION', 'SVEEndInputStream',
    'ISpeechPhraseAlternate', 'SVP_14', 'SpShortcut',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SFSOpen', 'DISPID_SRStatus',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SPISaveToMemory',
    'SAFT22kHz8BitStereo', 'SPDKL_CurrentConfig', 'SPLO_STATIC',
    'SGSEnabled', 'SSFMCreate', 'SVEAllEvents', 'ISpeechRecoGrammar',
    'DISPID_SRDisplayUI', 'SRSEDone', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SPRuleNumberOfElements', 'SREAudioLevel',
    'SpeechRetainedAudioOptions', 'ISpeechResourceLoader',
    'STSF_LocalAppData', 'SGDSInactive', 'ISpeechLexicon',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SRRAlternates',
    'SVEPrivate', 'SpMemoryStream', 'DISPID_SpeechVoiceEvent',
    'DISPID_SAFSetWaveFormatEx', 'SPWORDPRONOUNCEABLE',
    'ISpeechPhraseRules', 'SPBO_NONE', 'SPCS_ENABLED',
    'ISpeechPhraseAlternates', 'SPCT_SLEEP', 'DISPID_SPIGrammarId',
    'ISpeechGrammarRuleState', 'SVSFIsXML', 'SVSFParseMask',
    'SpeechTokenValueCLSID', 'eLEXTYPE_PRIVATE4',
    '_ISpeechRecoContextEvents', 'SPEI_UNDEFINED',
    'SPINTERFERENCE_NOISE', 'SPAUDIOOPTIONS', 'DISPID_SVEWord',
    'DISPID_SRGetRecognizers', 'SVP_1', 'SPPS_Noun', 'SVP_10',
    'DISPID_SOTsCount', 'ISpXMLRecoResult', 'ISpeechRecognizerStatus',
    'DISPID_SRSSupportedLanguages', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SREmulateRecognition', 'DISPID_SVEStreamEnd',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SVIsUISupported', 'SPSVerb',
    'DISPID_SLGetWords', 'DISPID_SWFEAvgBytesPerSec',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SRCEPhraseStart'
]

_check_version('1.1.14', 1633528316.302569)
